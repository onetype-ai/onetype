elements.ItemAdd({
	...
	render: function()
	{
		const icons = {overview: 'info', fields: 'data_object', items: 'list', functions: 'function', store: 'database', settings: 'tune', elements: 'widgets', commands: 'terminal', pipelines: 'account_tree', events: 'bolt'};
		const order = ['overview', 'fields', 'items', 'functions', 'store', 'settings', 'elements', 'commands', 'pipelines', 'events'];

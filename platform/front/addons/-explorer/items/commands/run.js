onetype.AddonReady('commands', (commands) =>
{
	commands.Item({
		id: 'explorer:run',
		exposed: true,
		description: 'Run an explorer entry by id, the same as selecting it in the search results. Emits explorer.run.',
		...
		{
			const item = explorer.ItemGet(properties.id);
			...
			onetype.Emit('explorer.run', { id: properties.id });

platform.collaborators.ElementAdd({
    id: 'avatars',
    icon: 'group',
    name: 'Collaborators',
    ...
    render: function()
    {
        const refresh = () =>
        {
            this.people = platform.collaborators.Fn('find.list');
        ...
        this.where = (person) =>
        {
            const spot = platform.collaborators.StoreGet('cursor:' + person.id) || { x: -100, y: -100 };

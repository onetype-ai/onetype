            ...
            <div class="box">
                <div class="ot-container-s ot-py-l">
                    ...
                    <div ot-if="mode !== 'search'" class="group">
                        ...
                        <e-admin-status-empty ot-if="mode === 'scope' && !section.selected" icon="person_search" :title="'No ' + section.label.toLowerCase() + ' selected'" :description="'Choose a ' + section.label.toLowerCase() + ' to see and edit their platform.settings.'"></e-admin-status-empty>
                        <e-admin-status-empty ot-if="mode === 'group' && !section.items.length" icon="tune" title="Nothing here" description="This group has no visible platform.settings."></e-admin-status-empty>
                        ${rows('section.items')}
                    </div>
                </div>
            </div>

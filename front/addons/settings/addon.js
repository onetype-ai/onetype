...
{
    platform.settings = onetype.Addon('platform.settings', (addon) =>
    {
        addon.Field('id', {
            type: 'string',
            required: true,
        ...
        addon.Field('onChange', {
            type: 'function',
            description: 'Called with the new value and the setting item after the value changes, before the settings change event fires.'
        });

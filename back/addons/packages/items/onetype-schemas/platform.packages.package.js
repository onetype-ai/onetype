onetype.schemas.ItemAdd({
    ...
    config: {
        ...
        status: {
            ...
            description: 'Whether the package is active in this container. Disabled packages exist on disk but do not load. Blocked is forced when a dependency is not loaded.'
        },
        message: {
            type: 'string',
            value: '',

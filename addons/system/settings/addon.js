const settings = onetype.Addon('settings', (addon) =>
{
	...
	addon.Field('onChange', {
		type: 'function',
		description: 'Called with the new value and the setting item after the value changes, before settings.change fires.'
	});
...
$ot.settings = {
	get: (id, fallback, instance) => settings.Fn('get', id, fallback, instance),
	set: (id, value, instance) => settings.Fn('set', id, value, instance)
};

commands.Item({
	...
	callback: function(properties, resolve)
	{
		...
		if(properties.scope)
		{
			const scope = modules.settings.Fn('scopes')[properties.scope];
		...
		{
			const group = modules.settings.Fn('groups', '').find((entry) => entry.id === properties.group);

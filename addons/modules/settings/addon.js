modules.settings = onetype.Addon('modules.settings', (addon) =>
{
	addon.Field('id', {
		type: 'string',
		required: true,
	...
	addon.Field('onChange', {
		type: 'function',
		description: 'Called with the new value and the setting item after the value changes, before modules.settings.change fires.'
	});
...
$ot.modules.settings = {
	get: (id, fallback, instance) => modules.settings.Fn('get', id, fallback, instance),
	set: (id, value, instance) => modules.settings.Fn('set', id, value, instance)
};

commands.Item({
	...
	exposed: true,
	description: 'Enable or disable a shortcut and persist it across reloads. Flips the current state unless enabled is passed explicitly. Emits modules.shortcuts.toggle. Does nothing when the shortcut is already in the requested state.',
	...
	callback: function(properties, resolve)
	{
		...
		if(!modules.shortcuts.Fn('toggle', properties.id, enabled))
		{

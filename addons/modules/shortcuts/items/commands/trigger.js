commands.Item({
	...
	exposed: true,
	description: 'Run a shortcut by id, the same as pressing its key combination. Emits modules.shortcuts.trigger before the callback executes. Fails when the shortcut does not exist or is disabled.',
	...
	callback: async function(properties, resolve)
	{
		...
		try
		{
			await modules.shortcuts.Fn('trigger', properties.id);

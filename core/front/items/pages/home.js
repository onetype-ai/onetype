	...
	areas: {
		app: function()
		{
			...
			return `
				...
				<div ot-if="ready" style="display: grid; width: 100%; height: 100%; grid-template-areas: 'navbar navbar' 'rail workspace' 'status status'; grid-template-columns: auto 1fr; grid-template-rows: 46px 1fr 26px;">
